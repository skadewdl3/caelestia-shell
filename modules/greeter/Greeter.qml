...
FocusScope {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Card {
                    ...
                    ColumnLayout {
                        ...
                        FetchLine { label: "host"; value: root.hostName }
                        FetchLine { label: "os"; value: root.osName }
                        FetchLine { label: "kernel"; value: root.kernelVersion }
                        FetchLine { label: "session"; value: "Hyprland / UWSM" }
                        Item { Layout.fillHeight: true }
                        ...
                        Item {
                            ...
                            BodyText {
                                ...
                                font.variableAxes: ({ "wdth": 42, "ROND": 20 })
                            }
                        }
                        Item { Layout.fillHeight: true }
                    }
                ...
                Card {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            PowerAction { icon: "bedtime"; label: "Suspend"; command: ["systemctl", "suspend"] }
                            PowerAction { icon: "restart_alt"; label: "Restart"; command: ["systemctl", "reboot"] }
                            PowerAction { icon: "power_settings_new"; label: "Power off"; command: ["systemctl", "poweroff"]; danger: true }
                        }
                        Item { Layout.fillHeight: true }
                    }
                }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    StatShape { Layout.fillWidth: true; icon: "device_thermostat"; value: `${root.cpuTemp}°`; label: "CPU"; accent: "#f4c642"; shapeType: MaterialShape.Pentagon }
                    StatShape { Layout.fillWidth: true; icon: "memory"; value: `${root.memoryPercent}%`; label: "RAM"; accent: "#e19c4c"; shapeType: MaterialShape.Cookie4Sided }
                    StatShape { Layout.fillWidth: true; icon: "hard_drive"; value: `${root.diskPercent}%`; label: "DISK"; accent: "#b1ad6a"; shapeType: MaterialShape.Gem }
                }
    ...
    component DisplayText: BodyText {
        color: root.primaryColour
        font.weight: 700
        font.variableAxes: ({ "wdth": 30, "ROND": 20 })
    }
    ...
    component MaterialGlyph: BodyText {
        ...
        font.variableAxes: ({ "FILL": fill, "wght": weight, "GRAD": -25 })
    }
    ...
    component StatShape: Item {
        ...
        Column {
            ...
            MaterialGlyph { anchors.horizontalCenter: parent.horizontalCenter; text: statShape.icon; color: root.primaryInk; font.pixelSize: 21; fill: 1 }
            BodyText { anchors.horizontalCenter: parent.horizontalCenter; text: statShape.value; color: root.primaryInk; font.pixelSize: value.length > 4 ? 12 : 19; font.weight: Font.Bold }
            BodyText { anchors.horizontalCenter: parent.horizontalCenter; text: statShape.label; color: Qt.rgba(root.primaryInk.r, root.primaryInk.g, root.primaryInk.b, 0.78); font.family: root.monoFont; font.pixelSize: 9; font.weight: Font.Bold }
        }
    }
    ...
    component StatusRow: Rectangle {
        ...
        RowLayout {
            ...
            MaterialGlyph { text: statusRow.icon; color: root.primaryColour; font.pixelSize: 27; fill: 1 }
            ColumnLayout {
                Layout.fillWidth: true
                spacing: 2
                RowLayout {
                    Layout.fillWidth: true
                    BodyText { Layout.fillWidth: true; text: statusRow.title; font.pixelSize: 15; font.weight: Font.DemiBold }
                    BodyText { text: statusRow.value; color: root.primaryColour; font.family: root.monoFont; font.pixelSize: 13; font.weight: Font.Bold }
                }
                BodyText { Layout.fillWidth: true; text: statusRow.detail; color: root.outline; font.pixelSize: 12; elide: Text.ElideRight }
                Rectangle {
                    Layout.fillWidth: true
                    Layout.topMargin: 3
